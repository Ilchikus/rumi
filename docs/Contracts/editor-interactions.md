...
| Review or remove a trashed page | Open Trash, select a viewable item, then Restore or Delete forever | Trashed pages remain addressable in a read-only page view even though they are absent from the sidebar. Restore is reversible; Delete forever always asks for confirmation. |
