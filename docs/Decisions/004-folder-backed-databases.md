...
- Database views, nested filters, table property visibility, and independent record-page property
  visibility follow [Decision 022](022-shared-database-views-and-record-page-visibility.md).
